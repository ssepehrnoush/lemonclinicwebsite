...
export const Route = createFileRoute("/face-analysis/analyzing")({
...
function AnalyzingPage() {
    ...
    (async () => {
      try {
        ...
        setTimeout(() => {
          ...
          navigate({ to: "/face-analysis/result" });
        }, wait);
      } catch (e) {
  ...
  return (
    <main className="ai-shell fixed inset-0 bg-black text-white overflow-hidden">
      {userImg && (
        <img
          src={userImg}
          alt=""
