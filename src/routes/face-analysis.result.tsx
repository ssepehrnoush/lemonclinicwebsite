...
import iconSparkle from "@/assets/ai/icon-sparkle.png";
import iconOrnament from "@/assets/ai/icon-ornament.png";
import iconTreatment from "@/assets/ai/icon-treatment.png";
import logoCutout from "@/assets/ai/logo-cutout.png.asset.json";
import dollLipAsset from "@/assets/ai/product-doll-lip.png.asset.json";
import naturalLipAsset from "@/assets/ai/product-natural-lip.png.asset.json";
import fullFaceAsset from "@/assets/ai/product-full-face.png.asset.json";
import underEyeAsset from "@/assets/ai/product-under-eye.png.asset.json";
...
export const Route = createFileRoute("/face-analysis/result")({
...
function ResultPage() {
  ...
  return (
    <main className="ai-shell relative min-h-screen bg-page text-foreground overflow-x-hidden">
